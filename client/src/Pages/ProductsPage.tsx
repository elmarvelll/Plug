...
function ProductPage(props: { businessId: string | null; product: string | null }) {
    ...
    return (
        <section
            style={{ width: '75%', height: '80%', display: 'flex', margin: '40px 0px', flexDirection: 'column', boxSizing: 'border-box', backgroundColor: 'black', borderRadius: '10px', padding: '20px' }}
        ...
        >
            <div style={{ display: 'flex', height: '100%' }}>
                ...
                <div style={{ width: '100%', height: '100%', backgroundColor: 'black', padding: '50px', overflow: 'auto', boxSizing: 'border-box', position: 'relative' }}>
                    ...
                    <h1 style={{ color: '#FF7A00', paddingBottom: '20px' }}>
                        ₦ {product.price}
                    </h1>
                    <div style={{ paddingBottom: '20px' }}>
