                    ...
                    <div className={styles.profile_overview}>
                        ...
                        <div className={styles.profile_info}>
                            <div style={{ position: 'relative', width: '40%', minWidth: '230px' }}>
                                ...
                                />
                                <FontAwesomeIcon icon={Editable === 'Name' ? faCheck : faPencil} color='#F5F7FA' onClick={() => Editable !== 'Name' ? edit('Name') : submit('BusinessName', business.BusinessName)} style={{ fontWeight: '100', position: 'absolute', bottom: '0', right: '0', margin: '10px', cursor: 'pointer' }} />
                            </div>
                            <div style={{ position: 'relative', width: '40%', minWidth: '230px' }}>
                                <h4>Category</h4>
                                <input
                                    ...
                                    readOnly
                                    onChange={(e) => UpdateCred(e)} />
                                <FontAwesomeIcon icon={Editable === 'Category' ? faCheck : faPencil} color='#F5F7FA' onClick={() => setEditable('Category')} style={{ fontWeight: '100', position: 'absolute', bottom: '0', right: '0', margin: '10px', cursor: 'pointer' }} />
                                {Editable === 'Category' &&
                            ...
                            <div style={{ position: 'relative', width: '100%' }}>
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => UpdateCred(e)} />
                                <FontAwesomeIcon icon={Editable === 'BusinessDescription' ? faCheck : faPencil} color='#F5F7FA' onClick={() => Editable !== 'BusinessDescription' ? edit('BusinessDescription') : submit('BusinessDescription', business.BusinessDescription)} style={{ fontWeight: '100', position: 'absolute', bottom: '0', right: '0', margin: '10px', cursor: 'pointer' }} />
                            </div >
                        </div>
                    </div>
                    <div className={styles.profile_overview}>
                        ...
                        <div className={styles.profile_info}>
                            <div style={{ position: 'relative', width: '40%', minWidth: '230px' }}>
                                ...
                                <input
                                    ...
                                    onChange={(e) => UpdateCred(e)} />
                                <FontAwesomeIcon icon={Editable === 'Number' ? faCheck : faPencil} color='#F5F7FA' onClick={() => Editable !== 'Number' ? edit('Number') : submit('Number', business.Number)} style={{ fontWeight: '100', position: 'absolute', bottom: '0', right: '0', margin: '10px', cursor: 'pointer' }} />
                            </div>
                            <div style={{ position: 'relative', width: '40%', minWidth: '230px' }}>
                                ...
                                <input
                                    ...
                                    onChange={(e) => UpdateCred(e)} />
                                <FontAwesomeIcon icon={Editable === 'Email' ? faCheck : faPencil} color='#F5F7FA' onClick={() => Editable !== 'Email' ? edit('Email') : submit('Email', business.Email)} style={{ fontWeight: '100', position: 'absolute', bottom: '0', right: '0', margin: '10px 5px', cursor: 'pointer' }} />
                            </div>
                        </div>
                    </div>
